...
// ICMPv4Header : Represents a ICMP header
// See https://en.wikipedia.org/wiki/Internet_Control_Message_Protocol#Header
...
// Code : Read the header's bytes and returns the code
